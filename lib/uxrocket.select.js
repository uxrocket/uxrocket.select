...
/*
    ...
    Select.prototype.setDropPositionForMobile = function(){
        var dropWidth = this.$drop.width(); 
        var windowWidth = $(window).width();
        console.log('windowwidth, dropwidth', windowWidth, dropWidth);
        var dropStyle          = {
            top:      '10px',
            left:     (windowWidth - dropWidth ) / 2,
            minWidth: '350px'
        };
