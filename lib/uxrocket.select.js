...
(function($) {
    ...
    var bindUIActions = function($el) {
        ...
        $('#uxitd-select-list-' + _opts.index).not('.uxitd-select-readonly').on(events.click, '.uxitd-select-option', function(e) {
            e.preventDefault();
            selectOption($(this));
        });
    ...
    ux = $.fn.select = $.uxselect = function(options) {
        ...
        return this.each(function() {
            ...
            uxrocket['uxSelect'] = {'hasWrapper': true, 'wrapper': 'uxitd-select-wrap', 'ready': 'uxitd-select-ready', 'selector': selector, 'options': options};
